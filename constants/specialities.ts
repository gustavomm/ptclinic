  ...
  pilates: {
    ...
    fullDescription: {
      ...
      patientList: [
        ...
        "Reabilitação e prevenção de lesões: Ajuda na recuperação de lesões e na prevenção de novos problemas, ao fortalecer o corpo de forma total",
        "Melhorar o condicionamento físico: Ideal para quem deseja um treino completo, que foca em força, mobilidade, estabilidade e resistência.",
      ],
      postDescription:
        "Seja para um treinamento mais avançado ou para começar do zero, o Pilates é uma excelente escolha para quem busca uma prática eficiente, segura e adaptável às suas necessidades.",
      howItWorks:
